...
ROV_REAR_THRUSTER_RIGHT = Servo(2, 1, servoMin, servoMax)
...
def handler(signum, frame):
	...
	setServoPercentage(ROV_REAR_THRUSTER_RIGHT, 0.50)
	setServoPercentage(ROV_REAR_THRUSTER_LEFT, 0.50)
	setServoPercentage(ROV_VERTICAL_THRUSTER_RIGHT, 0.50)
	setServoPercentage(ROV_VERTICAL_THRUSTER_LEFT, 0.50)
	GPIO.output(4, False)
	GPIO.cleanup()
	sys.exit(0)
...
print 'Setting servo output signal to 0.50'

print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_RIGHT, 0.50))
print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_LEFT, 0.50))
print 'Pulse value: ' + str(setServoPercentage(ROV_VERTICAL_THRUSTER_RIGHT, 0.50))
print 'Pulse value: ' + str(setServoPercentage(ROV_VERTICAL_THRUSTER_LEFT, 0.50))
...
while 1:
	# Try to find the arming setting
	#print 'Setting servo rear right output signal to ' + str(currentSetting)
	#print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_RIGHT, currentSetting))
	#
	#time.sleep(2)
	#currentSetting = currentSetting + 0.05
	
	print 'Setting to 0.55'
	
	print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_RIGHT, 0.54))
	print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_LEFT, 0.54))
	time.sleep(0.8)
	...
	print 'Setting to 0.45'
	
	print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_RIGHT, 0.46))
	print 'Pulse value: ' + str(setServoPercentage(ROV_REAR_THRUSTER_LEFT, 0.46))
	time.sleep(0.8)
